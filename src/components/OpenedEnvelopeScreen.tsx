...
export default function OpenedEnvelopeScreen({
    name1,
    name2,
    onGoCollage,
}: {
    ...
    return (
        <div className={styles.contentWrapper}>
            ...
            <div
                ...
                style={{ cursor: isLetterRevealed ? 'default' : 'pointer' }}
            >
                ...
                {/* Layer 2: Top envelope (env_open_top) - rendered before letter so letter appears on top */}
                <Image
                ...
                {/* Layer 3: Letter Content - only shows after envelope images loaded */}
                {allEnvelopeLoaded && (
                    <motion.div
